    ...
    $.printPreview = {
        loadPrintPreview: function () {
            ...
            print_frame_ref.write('<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">' +
                ...
                '<head><link href="/theme/1/Default/Style/Global.css" rel="stylesheet" type="text/css" /><link href="/theme/1/Default/Style/fonts.css" rel="stylesheet" type="text/css" /><link href="/CmsModules/Subject/print/src/print.css" rel="stylesheet" type="text/css" /> <title>' + document.title + '</title></head>' +
                '<body></body>' +
                '</html>');
